...
using ClearwoxCodeChallenge.Application.DTOs.Email;
using ClearwoxCodeChallenge.Application.Enums;
...
namespace ClearwoxCodeChallenge.Infrastructure.Identity.Services
{
